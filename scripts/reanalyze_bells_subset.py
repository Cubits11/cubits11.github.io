...
each carrying eleven systems' binary verdicts as columns. That release
is, as of 2026-08-27, the only public substrate in the Missing Column
Census on which joint stack statistics are computable at all — so this
script computes them, and claim MC-002 binds the result.
